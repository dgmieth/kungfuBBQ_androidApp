...
//const val DB_VERSION = 8 //added RememberMe
const val DB_VERSION = 9 //added maybeGo and eventOnly

const val DB_NAME = "kungfuBBQapp.db"

@Database(entities = [UserDB::class,RememberMeInfo::class,SocialMediaInfo::class,
